...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-3ea8shq.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-3ea8shq.containers.anotherwebservice.com/
...
```
git clone git@github.com:ThangNguyen157/container-3ea8shq.git
cd container-3ea8shq
```
...
```
docker attach container-3ea8shq
```
